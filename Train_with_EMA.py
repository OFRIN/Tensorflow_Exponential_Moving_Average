...
l2_reg_loss_op = tf.add_n([tf.nn.l2_loss(var) for var in train_vars]) * WEIGHT_DECAY
...
train_writer = tf.summary.FileWriter('./logs/train_100%_with_ema')
...
saver.save(sess, './model/EMA_100%.ckpt')
